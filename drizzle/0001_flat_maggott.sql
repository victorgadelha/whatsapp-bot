...
ALTER TABLE `messages` ALTER COLUMN "timestamp" TO "timestamp" text NOT NULL;--> statement-breakpoint
ALTER TABLE `messages` ADD `created_at` text DEFAULT (CURRENT_TIMESTAMP) NOT NULL;